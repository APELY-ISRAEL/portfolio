        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          order-2 xl:order-none">
            <div className="flex flex-col gap-[30px] h-[50px]">
              ...
              <h2 className="text-[42px] font-bold leading-none text-black group-hover:text-blue-600 transition-all
                ...
                <Link href={project.live}>
                  <TooltipProvider delayDuration={100}>
                    ...
                    justify-center items-center group">
                        <BsArrowUpRight className="text-black text-3xl group-hover:text-blue-600" />
                      </TooltipTrigger>
                      <TooltipContent>
                        <p>Live project</p>
                      </TooltipContent>
                ...
                <Link href={project.github}>
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      <TooltipTrigger className="w-[70px] h-[70px] rounded-full bg-white/5
                    justify-center items-center group">
                        <BsGithub className="text-black text-3xl group-hover:text-blue-600" />
                      </TooltipTrigger>
                      <TooltipContent>
