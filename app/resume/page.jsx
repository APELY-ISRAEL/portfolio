...
const experience = {
  ...
  description: "Lorem",
  items: [
    { company: "Easy Service", position: "Full Stack Developer", duration: "2025 - present" },
    { company: "Easy Summer", position: "Full Stack Developer", duration: "2025 - present" },
    { company: "Freelance", position: "Full Stack Developer", duration: "2025 - present" },
    { company: "Easy Tech", position: "Full Stack Developer", duration: "2025 - present" },
  ],
};
...
const education = {
  ...
  items: [
    { institution: "Easy Service", degree: "Full Stack Developer", duration: "2025" },
    { institution: "Easy Service", degree: "Full Stack Developer", duration: "2025" },
    { institution: "Easy Service", degree: "Full Stack Developer", duration: "2025 - present" },
    { institution: "Easy Service", degree: "Full Stack Developer", duration: "2025" },
  ],
};
                ...
                <ScrollArea className="h-[400px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map((item, index) => (
                      <li key={index}
                        className="bg-slate-800 h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1"
                      >
